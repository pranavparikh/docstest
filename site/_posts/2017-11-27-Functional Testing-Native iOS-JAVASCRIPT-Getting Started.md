...
Please follow the archetype project [otto-archetype-app](https://github.com/TestArmada/otto/otto-archetype-app) to have your first native app test automation project run in your local.
